...
export const Publish = () => {
    ...
    return <div>
        ...
        <div className="flex justify-center pt-4">
            <div>
                <input type="text" onChange={(e) => { setTitle(e.target.value) }} aria-describedby="helper-text-explanation" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-b;lue-500 block w-full p-2.5 mb-3 focus:outline-none " placeholder="Article title">
                </input>

                <TextArea onchange={(e) => { setDescription(e.target.value) }} />
                <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 hover:bg-blue-800" onClick={async () => {
...
function TextArea({ onchange }: { onchange: (e: ChangeEvent<HTMLTextAreaElement>) => void }) {
    return <div>
        <div className="max-w-[800px] lg:min-w-[700px] mb-4 border border-gray-200 rounded-lg bg-gray-50">
            ...
            <div className="px-4 py-2 bg-white rounded-b-lg ">
                ...
                <textarea id="editor" rows={8} className="block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:outline-none" placeholder="Write an article..." required onChange={onchange}></textarea>
            </div>
        </div>
